...
with open(totAndRamp) as tis_file, open("zPercentCorrected.csv", 'w') as tis_write:
    header = tis_file.readline().rstrip() + ",significant pairs,percent significant pairs\n"
