...
with open("geneExpressionCountsSpreadCellTypeCAI.csv") as cell_file, open("geneExpressionCountsTissueCAI.csv") as tissue_file:
    cell_file.readline()
...
with open("tissueBayes3.csv", 'w') as tissue_csv_file, open("cellTypeBayes3.csv", 'w') as cell_csv_file:
