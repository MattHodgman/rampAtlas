...
This version has been modified to be executable on Windows.
'''
...
if __name__ == '__main__':
    ...
    # print codonToSpeed
    f = open("tAI_" + str(args.rscu).replace('cellTypeGenes/', '').replace('.fa','') + ".csv", "a")
    for codon,rscu in codonToSpeed.items():
        f.write(codon + ',' + str(rscu))
        f.write('\n')
    f.close()
